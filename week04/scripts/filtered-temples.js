...
const temples = [
  ...
  const nonUtahTemple = document.querySelector("#nonUtah")
  const newTemples = document.querySelector("#new");
  const largeTemplate = document.querySelector("#large");
  ...
  function createTempleCard (filteredTemple)
  {
    ...
    filteredTemple.forEach(temple =>{
        ...
        dedication.innerHTML = `<span class ="label">Didicated : </span> ${temple.dedicated}`;
